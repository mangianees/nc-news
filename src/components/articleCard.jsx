...
const [isTakeAwayDisable,setIsTakeAwayDisable]=useState(false);
    ...
    console.log('dataOfArticle--->',dataOfArticle);
      setVotes((article_id)=>{
            const updatedArticle = dataOfArticle.map((articleData)=>{
              if(articleData.article_id===article_id){
                return {...articleData,voters: articleData.voters + vote}
              }
            return articleData
      ...
      console.log('Patched succesfull,',{updatedData});
      })
